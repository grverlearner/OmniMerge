<article
    ...
    <a href="{{ route('community.collections.show', $collection) }}" class="block">
    ...
    <div class="p-5">
        <a href="{{ route('community.creators.show', $collection->creator->username) }}"
            class="
            flex
            items-center
            gap-3
        ...
        ">
            ...
            <x-user-avatar :user="$collection->creator" size="sm" />
        ...
        <div class="mt-5 flex items-center gap-4 border-t border-slate-100 pt-4 text-xs font-semibold text-slate-500">
            ...
            <a href="{{ route('community.collections.show', $collection) }}"
