...
@php
    ...
    $trazos = match ($name) {
        ...
        'escudo' => '<path d="M12 3 4.5 6v5.5c0 4.6 3.2 8.2 7.5 9.5 4.3-1.3 7.5-4.9 7.5-9.5V6L12 3Z"/>',

        'escudo-check' => '<path d="M12 3 4.5 6v5.5c0 4.6 3.2 8.2 7.5 9.5 4.3-1.3 7.5-4.9 7.5-9.5V6L12 3Z"/>' .
            '<path d="m8.8 12 2.2 2.2 4.2-4.4"/>',

        'estrella' => '<path d="m12 3.5 2.6 5.3 5.9.9-4.25 4.1 1 5.8L12 16.9l-5.25 2.7 1-5.8L3.5 9.7l5.9-.9L12 3.5Z"/>',

        'prohibido' => '<circle cx="12" cy="12" r="8.5"/><path d="m6 6 12 12"/>',

        'bandera' => '<path d="M5 21V4"/><path d="M5 4.5h11l-2 4 2 4H5"/>',

        'pulso' => '<path d="M3 12h4l2.5-6 5 12 2.5-6h4"/>',

        'megafono' => '<path d="M4 10v4a1 1 0 0 0 1 1h2l8 4.5v-15L7 9H5a1 1 0 0 0-1 1Z"/><path d="M18.5 9a4 4 0 0 1 0 6"/>',

        'llave' => '<path d="M14.7 6.3a4.5 4.5 0 0 0-5.9 5.9L3.5 17.5V20.5h3l5.3-5.3a4.5 4.5 0 0 0 5.9-5.9l-2.7 2.7-2.9-.4-.4-2.9 3-2.4Z"/>',

        'subir' => '<path d="M12 15V4"/><path d="m7.5 8.5 4.5-4.5 4.5 4.5"/><path d="M4.5 15v3.5A2 2 0 0 0 6.5 20.5h11a2 2 0 0 0 2-2V15"/>',
