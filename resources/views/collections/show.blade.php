<x-app-layout>
    ...
    <article class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        <div
            class="relative min-h-64 bg-gradient-to-br from-indigo-500 to-violet-600 sm:min-h-80"
            style="
                background:
                    linear-gradient(
                        135deg,
                ...
                <div class="max-w-3xl">
                    ...
                    <p class="mt-3 whitespace-pre-line leading-8 text-slate-600">
                        {{ $collection->description
                            ?: 'Esta colección no tiene descripción.' }}
                    </p>
                </div>
    ...
    <section class="mt-8">
        ...
        <div class="mt-5 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
            ...
            @empty
                <div class="sm:col-span-2 xl:col-span-3 rounded-2xl border border-dashed border-slate-300 bg-white py-16 text-center text-slate-500">
