            ...
            <div class="flex flex-col justify-between gap-6 sm:flex-row sm:items-start">
                ...
                <div class="flex shrink-0 flex-wrap gap-2">
                    ...
                    <form method="POST"
                        ...
                        data-confirm-title="Eliminar Colección"
                        data-confirm-message="
        Esta Colección será eliminada
        de tu Biblioteca.
    "
                        data-confirm-subject="{{ $collection->name }}"
                        data-confirm-detail="
        Las Entidades contenidas en la Colección
        no se eliminan por esta acción.
    "
                        data-confirm-action="Eliminar Colección"
