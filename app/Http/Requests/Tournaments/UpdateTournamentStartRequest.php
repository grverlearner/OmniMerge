...
/*
|--------------------------------------------------------------------------
| UpdateTournamentStartRequest
|--------------------------------------------------------------------------
|
| Editar una entrada del torneo valida exactamente lo mismo que crearla, asi que hereda de
| StoreTournamentStartRequest en vez de repetir sus reglas.
|
...
|
*/
class UpdateTournamentStartRequest extends StoreTournamentStartRequest
{
}
