...
/*
|--------------------------------------------------------------------------
| UpdateTournamentTerminalRequest
|--------------------------------------------------------------------------
|
| Editar un final del torneo valida exactamente lo mismo que crearla, asi que hereda de
| StoreTournamentTerminalRequest en vez de repetir sus reglas.
|
...
|
*/
class UpdateTournamentTerminalRequest extends StoreTournamentTerminalRequest
{
}
